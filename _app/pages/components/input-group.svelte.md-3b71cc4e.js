...
</div>`,a,s,o,r;return{c(){e=d("pre"),a=y(n),this.h()},l(t){e=$(t,"PRE",{slot:!0});var l=f(e);a=P(l,n),l.forEach(i),this.h()},h(){c(e,"slot","react")},m(t,l){w(t,e,l),p(e,a),o||(r=I(s=k.call(null,e,{to:m[0]})),o=!0)},p(t,l){s&&A(s.update)&&l&1&&s.update.call(null,{to:t[0]})},d(t){t&&i(e),o=!1,r()}}}function Ue(m){let e,n,a,s,o,r,t,l,b,h,_,g,x,N,E,T,u,v,B,D,C,W,R,M,q,ee,te,F;return{c(){e=d("div"),n=d("div"),a=d("label"),s=d("span"),o=y("LG"),r=S(),t=d("input"),l=S(),b=d("div"),h=d("label"),_=d("span"),g=y("MD"),x=S(),N=d("input"),E=S(),T=d("div"),u=d("label"),v=d("span"),B=y("SM"),D=S(),C=d("input"),W=S(),R=d("div"),M=d("label"),q=d("span"),ee=y("XS"),te=S(),F=d("input"),this.h()},l(H){e=$(H,"DIV",{class:!0});var U=f(e);n=$(U,"DIV",{class:!0});var ae=f(n);a=$(ae,"LABEL",{class:!0});var K=f(a);s=$(K,"SPAN",{});var se=f(s);o=P(se,"LG"),se.forEach(i),r=L(K),t=$(K,"INPUT",{type:!0,placeholder:!0,class:!0}),K.forEach(i),ae.forEach(i),l=L(U),b=$(U,"DIV",{class:!0});var re=f(b);h=$(re,"LABEL",{class:!0});var J=f(h);_=$(J,"SPAN",{});var oe=f(_);g=P(oe,"MD"),oe.forEach(i),x=L(J),N=$(J,"INPUT",{type:!0,placeholder:!0,class:!0}),J.forEach(i),re.forEach(i),E=L(U),T=$(U,"DIV",{class:!0});var ne=f(T);u=$(ne,"LABEL",{class:!0});var Q=f(u);v=$(Q,"SPAN",{});var pe=f(v);B=P(pe,"SM"),pe.forEach(i),D=L(Q),C=$(Q,"INPUT",{type:!0,placeholder:!0,class:!0}),Q.forEach(i),ne.forEach(i),W=L(U),R=$(U,"DIV",{class:!0});var ue=f(R);M=$(ue,"LABEL",{class:!0});var Z=f(M);q=$(Z,"SPAN",{});var ie=f(q);ee=P(ie,"XS"),ie.forEach(i),te=L(Z),F=$(Z,"INPUT",{type:!0,placeholder:!0,class:!0}),Z.forEach(i),ue.forEach(i),U.forEach(i),this.h()},h(){c(t,"type","text"),c(t,"placeholder","Type here"),c(t,"class","input input-bordered input-lg"),c(a,"class","input-group input-group-lg"),c(n,"class","form-control"),c(N,"type","text"),c(N,"placeholder","Type here"),c(N,"class","input input-bordered input-md"),c(h,"class","input-group input-group-md"),c(b,"class","form-control"),c(C,"type","text"),c(C,"placeholder","Type here"),c(C,"class","input input-bordered input-sm"),c(u,"class","input-group input-group-sm"),c(T,"class","form-control"),c(F,"type","text"),c(F,"placeholder","Type here"),c(F,"class","input input-bordered input-xs"),c(M,"class","input-group input-group-xs"),c(R,"class","form-control"),c(e,"class","flex flex-col gap-4 items-center")},m(H,U){w(H,e,U),p(e,n),p(n,a),p(a,s),p(s,o),p(a,r),p(a,t),p(e,l),p(e,b),p(b,h),p(h,_),p(_,g),p(h,x),p(h,N),p(e,E),p(e,T),p(T,u),p(u,v),p(v,B),p(u,D),p(u,C),p(e,W),p(e,R),p(R,M),p(M,q),p(q,ee),p(M,te),p(M,F)},d(H){H&&i(e)}}}function Ce(m){let e,n=`<div class="$$form-control">
